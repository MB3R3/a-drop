        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#use-cases" className="text-background/70 hover:text-background transition-colors">Use Cases</a></li>
              <li><a href="#" className="text-background/70 hover:text-background transition-colors">Download App</a></li>
            </ul>
          </div>
